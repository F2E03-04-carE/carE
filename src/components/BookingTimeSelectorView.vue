    ...
    >
      ...
      <section class="flex flex-wrap justify-between">
        <div class="w-full md:w-[40%]">
          <!-- <DatePicker v-model="selectedDate" :min-date="today" class="" /> -->
          <div class="border border-[#e9e9e7] rounded-[8px]">日期選取器佔位</div>
        </div>
        <div class="flex flex-col w-full md:w-[55%] my-6 md:my-0">
          <div
            class="flex flex-col justify-center items-center p-4 bg-[#fbfbfa] border border-[#e9e9e7] rounded-[8px]"
          >
