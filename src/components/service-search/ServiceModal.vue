    ...
    <div class="absolute inset-0 flex items-center justify-center p-6">
      ...
      >
        ...
        <div class="px-10 pb-10 pt-12 text-center">
          <div
            class="mx-auto grid h-20 w-20 place-items-center rounded-full bg-[#F2F1EC] text-[#6B6B5C]"
          >
            <!-- <i class="fa-regular fa-circle-check text-4xl" aria-hidden="true"></i> -->
            <span class="material-symbols-outlined text-[50px] search-modal-check-icon">
              check_circle
            </span>
          </div>
          ...
          <div
            class="mx-auto mt-8 w-full max-w-[260px] rounded-2xl border border-[#E6E6DF] bg-[#F6F5F0] px-6 py-5"
          >
