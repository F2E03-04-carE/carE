...
export type MemberStatus = 'Active' | 'Suspended' | 'Pending' | 'VerifiedFree' | 'VerifiedPaid' | 'Expired';
...
export const getStatusClass = (status: MemberStatus): string => STATUS_CLASSES[status] || 'bg-gray-100 text-gray-800';